  ...
  <body>
    ...
    <div class="row over" >
        ...
        <div class="col-md-2 container">
            ...
            <main class="bd-content" role="main">
                ...
                <form action="/editar-frete/{{ $cotacao->id }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control" id="transportadora_id" name="transportadora_id" value="{{ $cotacao->transportadora_id }}">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="uf" name="uf" value="{{ $cotacao->uf }}">
                    </div>
    ...
    <div class="row">
        <div class="container box_grid">
            ...
            <!-- Listagem -->
            <div class="row linha_grid">
                <div class="col coluna_grid"> <input type="text" name="uf" value="{{ $cotacao->uf }}"> </div>
                <div class="col coluna_grid"> 1 de 3 </div>
                <div class="col coluna_grid"> 1 de 3 </div>
                <div class="col coluna_grid"> 1 de 3 </div>
                <div class="col"> 1 de 3 </div>
