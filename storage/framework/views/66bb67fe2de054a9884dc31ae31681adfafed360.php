            ...
            <main class="bd-content" role="main">
                ...
                <form action="/cotacao_frete" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php $__errorArgs = ['transportadora_id'];
...
unset($__errorArgs, $__bag); ?>" id="transportadora_id" name="transportadora_id">
                            ...
                            <option value="<?php echo e($transportadora->id); ?>"><?php echo e($transportadora->nome); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['transportadora_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php $__errorArgs = ['uf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['percentual_cotacao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="percentual_cotacao" name="percentual_cotacao" placeholder="2.5">
                        <?php $__errorArgs = ['percentual_cotacao'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['valor_extra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="valor_extra" name="valor_extra" placeholder="8,90">
                        <?php $__errorArgs = ['valor_extra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row">
        <div class="container box_grid">
            ...
            <div class="row linha_grid">
                <div class="col coluna_grid"> <?php echo e($cadastro->id); ?>  </div>
                <div class="col coluna_grid"> <?php echo e($cadastro->uf); ?> </div>
                <div class="col coluna_grid"> <?php echo e($cadastro->percentual_cotacao); ?> </div>
                <div class="col coluna_grid"> <?php echo e($cadastro->valor_extra); ?> </div>
                <div class="col"> <?php echo e($cadastro->transportadora_id); ?> </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>    
    </div>
...
<?php /**PATH C:\wampk\www\cotacao_frete\resources\views/home.blade.php ENDPATH**/ ?>